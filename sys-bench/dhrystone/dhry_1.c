...
#define Too_Small_Time 2000000
		/* Measurements should last at least 2000000 micro-seconds */
#endif
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  Begin_Time = time_info.tv_sec * 1000000 + time_info.tv_usec;
#endif
...
#else
  gettimeofday(&time_info, NULL);	
  End_Time = time_info.tv_sec * 1000000 + time_info.tv_usec;
#endif
...
#elif defined TIMES
    Microseconds = (double) User_Time * (double) Mic_secs_Per_Second 
                        / ((double) HZ * ((double) Number_Of_Runs));
    Dhrystones_Per_Second = ((double) HZ * (double) Number_Of_Runs)
                        / (double) User_Time;
#else
    Microseconds = (double) User_Time;
    Dhrystones_Per_Second = (double) Number_Of_Runs * 1000000.0 / Microseconds;	
#endif
